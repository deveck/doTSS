...
{
    [TPMConsoleCommand("tpm_session_bind")]
    public class TPMSessionBindCommand : ConsoleCommandBase
    {
        ...
        public override string HelpText
        {
            get
            {
                return @"tpm_session_bind Args: [local_session_alias]  {args} [embedded data]
